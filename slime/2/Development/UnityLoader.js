...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'SlimeUnityBallWebGLBuild2.data';
    var REMOTE_PACKAGE_BASE = 'SlimeUnityBallWebGLBuild2.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3165319;
      var PACKAGE_UUID = '112e6352-7210-4e6e-a428-2434b8163bc8';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 111035, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(111035, 111217, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(111217, 1642393, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1642393, 3137693, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3137693, 3165319, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_SlimeUnityBallWebGLBuild2.data');

    };
    Module['addRunDependency']('datafile_SlimeUnityBallWebGLBuild2.data');
